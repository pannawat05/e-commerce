...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="?p=0" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Rabbitshop</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="image/person.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?p=list" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>รายการสินค้าทั้งหมด</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?p=order" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>คำสั่งซื่อล่าสุด</p>
                </a>
              </li>
            </ul>
          </li>
...
?>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><?php echo $p; ?></a></li>
              <li class="breadcrumb-item active">Adminconsole</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
include('dashboard.php');
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="p-3">
      <h5>account</h5>
      <b><a href="Log_out.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
